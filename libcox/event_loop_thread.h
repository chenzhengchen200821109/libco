...
class EventLoopThread : public ServerStatus {
    ...
    public:
        ...
        // wait_thread_started - If it is true this method will block
        //                       until the thread totally started
        // pre - This functor will be executed immediately when the thread is started. 
        // post - This functor will be executed at the moment when the thread is going to stop.
        ...
        // Join the thread. If you forget to call this method,
        // it will be invoked automatically in the destruct method ~EventLoopThread().
        // DO NOT call this method from any of the working thread.
        void Join();
